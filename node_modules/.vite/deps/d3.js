...
function ribbon(headRadius) {
  ...
  function ribbon2() {
    ...
    if (!context)
      context = buffer = path();
    if (ap > epsilon2) {
      if (abs(sa1 - sa0) > ap * 2 + epsilon2)
        sa1 > sa0 ? (sa0 += ap, sa1 -= ap) : (sa0 -= ap, sa1 += ap);
      else
        sa0 = sa1 = (sa0 + sa1) / 2;
      if (abs(ta1 - ta0) > ap * 2 + epsilon2)
...
function contours_default() {
  ...
  contours.thresholds = function(_) {
    return arguments.length ? (threshold2 = typeof _ === "function" ? _ : Array.isArray(_) ? constant_default2(slice2.call(_)) : constant_default2(_), contours) : threshold2;
  };
...
function density_default() {
  var x4 = defaultX, y4 = defaultY, weight = defaultWeight, dx = 960, dy = 500, r = 20, k2 = 2, o = r * 3, n = dx + o * 2 >> k2, m3 = dy + o * 2 >> k2, threshold2 = constant_default2(20);
  function grid(data) {
  ...
  density.x = function(_) {
    return arguments.length ? (x4 = typeof _ === "function" ? _ : constant_default2(+_), density) : x4;
  };
  density.y = function(_) {
    return arguments.length ? (y4 = typeof _ === "function" ? _ : constant_default2(+_), density) : y4;
  };
  density.weight = function(_) {
    return arguments.length ? (weight = typeof _ === "function" ? _ : constant_default2(+_), density) : weight;
  };
  ...
  density.thresholds = function(_) {
    return arguments.length ? (threshold2 = typeof _ === "function" ? _ : Array.isArray(_) ? constant_default2(slice2.call(_)) : constant_default2(_), density) : threshold2;
  };
...
function link_default(links) {
  var id = index2, strength = defaultStrength, strengths, distance = constant_default3(30), distances, nodes, count3, bias, random, iterations2 = 1;
  if (links == null)
    links = [];
...
function circle_default() {
  var center2 = constant_default4([0, 0]), radius = constant_default4(90), precision = constant_default4(2), ring, rotate, stream = { point: point6 };
...
function pointEqual_default(a4, b) {
  return abs2(a4[0] - b[0]) < epsilon6 && abs2(a4[1] - b[1]) < epsilon6;
}
...
function longitude(point6) {
  return abs2(point6[0]) <= pi3 ? point6[0] : sign(point6[0]) * ((abs2(point6[0]) + pi3) % tau4 - pi3);
}
  ...
  return {
    ...
    point: function(lambda12, phi12) {
      ...
      if (abs2(delta - pi3) < epsilon6) {
        ...
        if (abs2(lambda04 - sign0) < epsilon6)
          lambda04 -= sign0 * epsilon6;
        if (abs2(lambda12 - sign1) < epsilon6)
...
function clipAntimeridianIntersect(lambda04, phi02, lambda12, phi12) {
  ...
  return abs2(sinLambda0Lambda1) > epsilon6 ? atan((sin2(phi02) * (cosPhi1 = cos2(phi12)) * sin2(lambda12) - sin2(phi12) * (cosPhi03 = cos2(phi02)) * sin2(lambda04)) / (cosPhi03 * cosPhi1 * sinLambda0Lambda1)) : (phi02 + phi12) / 2;
}
function clipAntimeridianInterpolate(from, to, direction, stream) {
  ...
  if (from == null) {
    ...
    stream.point(-pi3, 0);
    stream.point(-pi3, phi2);
  } else if (abs2(from[0] - to[0]) > epsilon6) {
...
function circle_default2(radius) {
  var cr = cos2(radius), delta = 2 * radians, smallRadius = cr > 0, notHemisphere = abs2(cr) > epsilon6;
  ...
  function intersect2(a4, b, two) {
    ...
    var delta2 = lambda12 - lambda04, polar = abs2(delta2 - pi3) < epsilon6, meridian = polar || delta2 < epsilon6;
    if (!polar && phi12 < phi02)
      z = phi02, phi02 = phi12, phi12 = z;
    if (meridian ? polar ? phi02 + phi12 > 0 ^ q[1] < (abs2(q[0] - lambda04) < epsilon6 ? phi02 : phi12) : phi02 <= q[1] && q[1] <= phi12 : delta2 > pi3 ^ (lambda04 <= q[0] && q[0] <= lambda12)) {
...
function resample(project, delta2) {
  function resampleLineTo(x06, y06, lambda04, a0, b0, c0, x12, y12, lambda12, a1, b1, c1, depth, stream) {
    ...
    if (d2 > 4 * delta2 && depth--) {
      var a4 = a0 + a1, b = b0 + b1, c6 = c0 + c1, m3 = sqrt(a4 * a4 + b * b + c6 * c6), phi2 = asin(c6 /= m3), lambda22 = abs2(abs2(c6) - 1) < epsilon6 || abs2(lambda04 - lambda12) < epsilon6 ? (lambda04 + lambda12) / 2 : atan2(b, a4), p = project(lambda22, phi2), x22 = p[0], y22 = p[1], dx2 = x22 - x06, dy2 = y22 - y06, dz = dy * dx2 - dx * dy2;
...
function conicConformalRaw(y06, y12) {
  ...
  project.invert = function(x4, y4) {
    var fy = f - y4, r = sign(n) * sqrt(x4 * x4 + fy * fy), l = atan2(x4, abs2(fy)) * sign(fy);
    if (fy * n < 0)
...
function conicEquidistantRaw(y06, y12) {
  ...
  project.invert = function(x4, y4) {
    var gy = g - y4, l = atan2(x4, abs2(gy)) * sign(gy);
    if (gy * n < 0)
...
function transformer2() {
  var domain = unit, range4 = unit, interpolate = value_default, transform2, untransform, unknown, clamp = identity, piecewise2, output, input;
  function rescale() {
...
function continuous() {
  return transformer2()(identity, identity);
}
...
function powish(transform2) {
  var scale2 = transform2(identity, identity), exponent = 1;
  function rescale() {
    return exponent === 1 ? transform2(identity, identity) : exponent === 0.5 ? transform2(transformSqrt, transformSquare) : transform2(transformPow(exponent), transformPow(1 / exponent));
  }
...
function radial() {
  ...
  scale2.range = function(_) {
    return arguments.length ? (squared.range((range4 = Array.from(_, number2)).map(square)), scale2) : range4.slice();
  };
  scale2.rangeRound = function(_) {
...
function transformer3() {
  var x06 = 0, x12 = 1, t02, t12, k10, transform2, interpolator = identity, clamp = false, unknown;
  function scale2(x4) {
...
function transformer4() {
  var x06 = 0, x12 = 0.5, x22 = 1, s2 = 1, t02, t12, t2, k10, k21, interpolator = identity, transform2, clamp = false, unknown;
  function scale2(x4) {
...
function diverging() {
  var scale2 = linearish(transformer4()(identity));
  scale2.copy = function() {
...
function cornerTangents(x06, y06, x12, y12, r1, rc, cw) {
  var x01 = x06 - x12, y01 = y06 - y12, lo = (cw ? rc : -rc) / sqrt3(x01 * x01 + y01 * y01), ox = lo * y01, oy = -lo * x01, x11 = x06 + ox, y11 = y06 + oy, x10 = x12 + ox, y10 = y12 + oy, x004 = (x11 + x10) / 2, y004 = (y11 + y10) / 2, dx = x10 - x11, dy = y10 - y11, d2 = dx * dx + dy * dy, r = r1 - rc, D2 = x11 * y10 - x10 * y11, d = (dy < 0 ? -1 : 1) * sqrt3(max3(0, r * r * d2 - D2 * D2)), cx0 = (D2 * dy - dx * d) / d2, cy0 = (-D2 * dx - dy * d) / d2, cx1 = (D2 * dy + dx * d) / d2, cy1 = (-D2 * dx + dy * d) / d2, dx0 = cx0 - x004, dy0 = cy0 - y004, dx1 = cx1 - x004, dy1 = cy1 - y004;
...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon7))
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da2, da1 = da2, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon7 && (padRadius ? +padRadius.apply(this, arguments) : sqrt3(r0 * r0 + r1 * r1)), rc = min2(abs3(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t02, t12;
      if (rp > epsilon7) {
...
function line_default2(x4, y4) {
  var defined = constant_default6(true), context = null, curve = linear_default, output = null, path2 = withPath(line);
  ...
  line.x = function(_) {
    return arguments.length ? (x4 = typeof _ === "function" ? _ : constant_default6(+_), line) : x4;
  };
  line.y = function(_) {
    return arguments.length ? (y4 = typeof _ === "function" ? _ : constant_default6(+_), line) : y4;
  };
...
function area_default5(x06, y06, y12) {
  var x12 = null, defined = constant_default6(true), context = null, curve = linear_default, output = null, path2 = withPath(area);
  x06 = typeof x06 === "function" ? x06 : x06 === void 0 ? x3 : constant_default6(+x06);
  y06 = typeof y06 === "function" ? y06 : y06 === void 0 ? constant_default6(0) : constant_default6(+y06);
  y12 = typeof y12 === "function" ? y12 : y12 === void 0 ? y3 : constant_default6(+y12);
  function area(data) {
  ...
  area.x = function(_) {
    return arguments.length ? (x06 = typeof _ === "function" ? _ : constant_default6(+_), x12 = null, area) : x06;
  };
  area.x0 = function(_) {
    return arguments.length ? (x06 = typeof _ === "function" ? _ : constant_default6(+_), area) : x06;
  };
  area.x1 = function(_) {
    return arguments.length ? (x12 = _ == null ? null : typeof _ === "function" ? _ : constant_default6(+_), area) : x12;
  };
  area.y = function(_) {
    return arguments.length ? (y06 = typeof _ === "function" ? _ : constant_default6(+_), y12 = null, area) : y06;
  };
  area.y0 = function(_) {
    return arguments.length ? (y06 = typeof _ === "function" ? _ : constant_default6(+_), area) : y06;
  };
  area.y1 = function(_) {
    return arguments.length ? (y12 = _ == null ? null : typeof _ === "function" ? _ : constant_default6(+_), area) : y12;
  };
...
function pie_default() {
  var value = identity_default5, sortValues = descending_default, sort2 = null, startAngle = constant_default6(0), endAngle = constant_default6(tau5), padAngle = constant_default6(0);
  function pie(data) {
...
function link2(curve) {
  ...
  link3.x = function(_) {
    return arguments.length ? (x4 = typeof _ === "function" ? _ : constant_default6(+_), link3) : x4;
  };
  link3.y = function(_) {
    return arguments.length ? (y4 = typeof _ === "function" ? _ : constant_default6(+_), link3) : y4;
  };
...
function zoom_default2() {
  ...
  zoom.extent = function(_) {
    return arguments.length ? (extent2 = typeof _ === "function" ? _ : constant_default7([[+_[0][0], +_[0][1]], [+_[1][0], +_[1][1]]]), zoom) : extent2;
  };
