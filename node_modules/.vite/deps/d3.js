...
function thresholdFreedmanDiaconis(values, min3, max4) {
  ...
  return c6 && d ? Math.ceil((max4 - min3) / (2 * d * Math.pow(c6, -1 / 3))) : 1;
}

// node_modules/d3-array/src/threshold/scott.js
function thresholdScott(values, min3, max4) {
  const c6 = count(values), d = deviation(values);
  return c6 && d ? Math.ceil((max4 - min3) * Math.cbrt(c6) / (3.49 * d)) : 1;
}
...
function contours_default() {
  ...
  contours.thresholds = function(_) {
    return arguments.length ? (threshold2 = typeof _ === "function" ? _ : Array.isArray(_) ? constant_default2(slice3.call(_)) : constant_default2(_), contours) : threshold2;
  };
...
function density_default() {
  ...
  density.thresholds = function(_) {
    return arguments.length ? (threshold2 = typeof _ === "function" ? _ : Array.isArray(_) ? constant_default2(slice3.call(_)) : constant_default2(_), density) : threshold2;
  };
