import { c as current_effect, M as MANAGED, a as current_block, b as current_component_context, s as schedule_effect, R as RENDER_EFFECT, D as DIRTY, S as SOURCE, C as CLEAN, i as is_frozen, d as STATE_SYMBOL, o as object_prototype, e as array_prototype, f as define_property, g as is_array, h as set, u as updating_derived, j as get_descriptor, k as get, U as UNINITIALIZED, l as untrack, m as get_prototype_of, p as set_signal_value, q as ROOT_BLOCK, r as flush_sync, t as array_from, v as destroy_signal, w as push, x as pop, y as render, z as push$1, A as setContext, B as create_anchor, E as bind_props, F as pop$1 } from "./index.js";
let base = "";
let assets = base;
...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!doctype html>\n<html lang="en" class="home">\n	<head>\n		<script>\n			let root = document.documentElement;\n			let colorScheme = localStorage.colorScheme ?? "light dark";\n			root.style.setProperty("color-scheme", colorScheme);\n		<\/script>\n		\n		\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets2 + `/favicon.png" />
		...
		<title>Riley Oh's Personal Site</title>
		<link rel="stylesheet" href="` + assets2 + '/style.css" />\n		<script src="' + assets2 + '/global.js" type="module"><\/script>\n		' + head + '\n	</head>\n	<body data-sveltekit-preload-data="hover">\n		<div style="display: contents">' + body + "</div>\n	</body>\n</html>\n",
